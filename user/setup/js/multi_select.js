(function($)
{
    function wrapSelected(count)
    {
        ...
        $('.tags_container').eq(count).html(list);

        $('.delete_tag').click(function()
        {
            var $t=$(this).parent().closest('.tags_container');
            var index=$('.tags_container').index($t);
    ...
    function setOptions(box)
    {
        ...
        var index=$(".multiBox").index(box);//$(box).parent().find(".multiBox").index(box);
    ...
    $.fn.setMultiSelect=function()
    {
        ...
        return this.each(function()
        {
            ...
            $(this).wrap($box);
            $(this).hide();
            $("<div class='tags_container'/>").css({"white-space":"nowrap","display":"inline-block","padding":"3px","width":"190px","height":"25px","overflow":"scroll"}).insertAfter(this);
